...
namespace MS.API.Mini.Migrations
{
    ...
    [Migration("20250708171659_AddedParams_")]
    partial class AddedParams_
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MS.API.Mini.Data.Models.PluginMonitoringResult", b =>
                {
                    ...
                    b.Property<Guid>("MonitoringResultId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PluginMetrics")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasAnnotation("Relational:JsonPropertyName", "Metrics");
            ...
            modelBuilder.Entity("MS.API.Mini.Data.Models.SystemMonitor", b =>
                {
                    ...
                    b.Property<string>("CurrentHealthCheck")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                        .HasDefaultValue("UnknownStatus")
